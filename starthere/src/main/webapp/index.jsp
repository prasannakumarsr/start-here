...
<link href="WebContent/css/font-awesome.min.css" rel="stylesheet">
<link href="WebContent/css/animate.min.css" rel="stylesheet">
<link href="WebContent/css/prettyPhoto.css" rel="stylesheet">
<link href="WebContent/css/main.css" rel="stylesheet">
<link href="WebContent/css/responsive.css" rel="stylesheet">
<!--[if lt IE 9]>
    <script src="WebContent/js/html5shiv.js"></script>
    <script src="WebContent/js/respond.min.js"></script>
    <![endif]-->
<link rel="shortcut icon" href="images/ico/favicon.ico">
<link rel="apple-touch-icon-precomposed" sizes="144x144"
	href="WebContent/images/ico/apple-touch-icon-144-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114"
	href="WebContent/images/ico/apple-touch-icon-114-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72"
	href="WebContent/images/ico/apple-touch-icon-72-precomposed.png">
<link rel="apple-touch-icon-precomposed"
	href="WebContent/images/ico/apple-touch-icon-57-precomposed.png">
</head>
<!--/head-->
...
<body class="homepage">
			...
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html"><img
						src="WebContent/images/logo.png" alt="logo"></a>
				</div>
		...
		<div class="carousel slide">
			...
			<div class="carousel-inner">
				...
				<div class="item active"
					style="background-image: url(WebContent/images/slider/bg1.jpg)">
					<div class="container">
						<div class="row slide-margin">
							...
							<div class="col-sm-6 hidden-xs animation animated-item-4">
								<div class="slider-img">
									<img src="WebContent/images/slider/img1.png"
				...
				<div class="item"
					style="background-image: url(WebContent/images/slider/bg2.jpg)">
					<div class="container">
						<div class="row slide-margin">
							<div class="col-sm-6">
								<div class="carousel-content">
							...
							<div class="col-sm-6 hidden-xs animation animated-item-4">
								<div class="slider-img">
									<img src="WebContent/images/slider/img2.png"
										class="img-responsive">
								</div>
							</div>
				...
				<div class="item"
					style="background-image: url(WebContent/images/slider/bg3.jpg)">
					<div class="container">
						<div class="row slide-margin">
							<div class="col-sm-6">
								<div class="carousel-content">
							...
							<div class="col-sm-6 hidden-xs animation animated-item-4">
								<div class="slider-img">
									<img src="WebContent/images/slider/img3.png"
										class="img-responsive">
								</div>
							</div>
						</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item1.png" alt="">
						<div class="overlay">
				...
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item2.png" alt="">
						<div class="overlay">
							<div class="recent-work-inner">
								<h3>
									<a href="#">Business theme</a>
				...
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item3.png" alt="">
						<div class="overlay">
							<div class="recent-work-inner">
								<h3>
									<a href="#">Business theme </a>
				...
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item4.png" alt="">
						<div class="overlay">
							<div class="recent-work-inner">
								<h3>
									<a href="#">Business theme </a>
				...
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item5.png" alt="">
						<div class="overlay">
							<div class="recent-work-inner">
								<h3>
									<a href="#">Business theme</a>
				...
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item6.png" alt="">
						<div class="overlay">
							<div class="recent-work-inner">
								<h3>
									<a href="#">Business theme </a>
				...
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item7.png" alt="">
						<div class="overlay">
							<div class="recent-work-inner">
								<h3>
									<a href="#">Business theme </a>
				...
				<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="recent-work-wrap">
						<img class="img-responsive"
							src="WebContent/images/portfolio/recent/item8.png" alt="">
						<div class="overlay">
							<div class="recent-work-inner">
								<h3>
									<a href="#">Business theme </a>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4">
					<div class="media services-wrap wow fadeInDown">
						<div class="pull-left">
							<img class="img-responsive"
								src="WebContent/images/services/services1.png">
						</div>
				...
				<div class="col-sm-6 col-md-4">
					<div class="media services-wrap wow fadeInDown">
						<div class="pull-left">
							<img class="img-responsive"
								src="WebContent/images/services/services2.png">
						</div>
						<div class="media-body">
							<h3 class="media-heading">SEO Marketing</h3>
							<p>Lorem ipsum dolor sit ame consectetur adipisicing elit</p>
				...
				<div class="col-sm-6 col-md-4">
					<div class="media services-wrap wow fadeInDown">
						<div class="pull-left">
							<img class="img-responsive"
								src="WebContent/images/services/services3.png">
						</div>
						<div class="media-body">
							<h3 class="media-heading">SEO Marketing</h3>
							<p>Lorem ipsum dolor sit ame consectetur adipisicing elit</p>
				...
				<div class="col-sm-6 col-md-4">
					<div class="media services-wrap wow fadeInDown">
						<div class="pull-left">
							<img class="img-responsive"
								src="WebContent/images/services/services4.png">
						</div>
						<div class="media-body">
							<h3 class="media-heading">SEO Marketing</h3>
							<p>Lorem ipsum dolor sit ame consectetur adipisicing elit</p>
				...
				<div class="col-sm-6 col-md-4">
					<div class="media services-wrap wow fadeInDown">
						<div class="pull-left">
							<img class="img-responsive"
								src="WebContent/images/services/services5.png">
						</div>
						<div class="media-body">
							<h3 class="media-heading">SEO Marketing</h3>
							<p>Lorem ipsum dolor sit ame consectetur adipisicing elit</p>
				...
				<div class="col-sm-6 col-md-4">
					<div class="media services-wrap wow fadeInDown">
						<div class="pull-left">
							<img class="img-responsive"
								src="WebContent/images/services/services6.png">
						</div>
						<div class="media-body">
							<h3 class="media-heading">SEO Marketing</h3>
							<p>Lorem ipsum dolor sit ame consectetur adipisicing elit</p>
								...
								<div id="collapseOne1" class="panel-collapse collapse in">
									<div class="panel-body">
										<div class="media accordion-inner">
											<div class="pull-left">
												<img class="img-responsive"
													src="WebContent/images/accordion1.png">
											</div>
											<div class="media-body">
							...
							<div class="parrent media-body">
								<div class="tab-content">
									<div class="tab-pane fade" id="tab1">
										<div class="media">
											<div class="pull-left">
												<img class="img-responsive" src="WebContent/images/tab2.png">
											</div>
											<div class="media-body">
												<h2>Adipisicing elit</h2>
												<p>There are many variations of passages of Lorem Ipsum
									...
									<div class="tab-pane fade active in" id="tab2">
										<div class="media">
											<div class="pull-left">
												<img class="img-responsive" src="WebContent/images/tab1.png">
											</div>
											<div class="media-body">
												<h2>Adipisicing elit</h2>
												<p>There are many variations of passages of Lorem Ipsum
						...
						<div class="media testimonial-inner">
							<div class="pull-left">
								<img class="img-responsive img-circle"
									src="WebContent/images/testimonials1.png">
							</div>
							<div class="media-body">
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
			...
			<div class="partners">
				<ul>
					<li><a href="#"><img class="img-responsive wow fadeInDown"
							...
							src="WebContent/images/partners/partner1.png"></a></li>
					<li><a href="#"><img class="img-responsive wow fadeInDown"
							data-wow-duration="1000ms" data-wow-delay="600ms"
							src="WebContent/images/partners/partner2.png"></a></li>
					<li><a href="#"><img class="img-responsive wow fadeInDown"
							data-wow-duration="1000ms" data-wow-delay="900ms"
							src="WebContent/images/partners/partner3.png"></a></li>
					<li><a href="#"><img class="img-responsive wow fadeInDown"
							data-wow-duration="1000ms" data-wow-delay="1200ms"
							src="WebContent/images/partners/partner4.png"></a></li>
					<li><a href="#"><img class="img-responsive wow fadeInDown"
							data-wow-duration="1000ms" data-wow-delay="1500ms"
							src="WebContent/images/partners/partner5.png"></a></li>
				</ul>
			</div>
		</div>
		<!--/.container-->
	...
	<script src="WebContent/js/jquery.prettyPhoto.js"></script>
	<script src="WebContent/js/jquery.isotope.min.js"></script>
				...
				<div class="tab-content">
					<div id="login" class="tab-pane fade in active">
						<form class="form-horizontal"
							action="http://localhost:8080/starthere/api/pk/login" role="form"
							id="doLogin" method="post">
							<div class="form-group">
								<label class="control-label col-sm-3" for="email">Email:</label>
								<div class="col-sm-5">
									<input type="email" id="username" name="username"
										path="username" class="form-control" placeholder="Enter email"
										required>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-5">
									<button type="button" onclick="return validateLogin();"
										class="btn btn-success btn-block">Log In</button>
									<div style="font-size: 14px;" class="text-center">
										<a href="#" id="color_blue" target="_blank">Forgot
											Password?</a>
									</div>
								</div>
